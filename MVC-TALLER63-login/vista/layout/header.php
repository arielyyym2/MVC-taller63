        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?accion=reporte">Reporte de Alumnos</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="index.php?accion=registrarAlumno">Registrar</a></li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="index.php?accion=logout">Cerras Sesión</a>
                    </li>
